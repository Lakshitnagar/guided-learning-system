...
test('Should first render', function (assert) {
    ...
    const expectedHTML = '<div class="tooltip TOOLTIP CLASSES in RIGHT" style="position: absolute; display: flex; align-items: center;"><div role="region" tabindex="999" aria-label="Steps" style="border: 1px solid rgb(223, 225, 229); border-radius: 5px; padding: 5px; box-shadow: rgba(0, 0, 0, 0.2) 0px 4px 8px 0px, rgba(0, 0, 0, 0.19) 0px 6px 20px 0px;"><div data-iridize-role="title" class="popover-title"><button aria-label="Close" data-iridize-role="closeBt">✕</button></div><div class="popover-content"><div data-iridize-id="content"><p>CONTENT</p></div></div><div class="stFooter" data-iridize-id="footer"><div><span class="steps-count">Step <span data-iridize-role="stepCount">1</span>/<span data-iridize-role="stepsCount">1</span></span><button tabindex="999" class="prev-btn default-later-btn" data-iridize-role="laterBt">Remind me later</button><span class="powered-by">Powered by </span></div><div data-iridize-role="nextBtPane"><button tabindex="999" class="prev-btn default-prev-btn" data-iridize-role="prevBt">Back</button><a tabindex="999" role="button" aria-label="Next" class="next-btn" data-iridize-role="nextBt" href="javascript:void(0);">Next</a></div></div></div></div>';
...
test('Should render next', function (assert) {
    ...
    const expectedHTML = '<div class="tooltip TOOLTIP CLASSES NEXT in TOP" style="position: absolute; display: flex; align-items: center;"><div role="region" tabindex="999" aria-label="Steps" style="border: 1px solid rgb(223, 225, 229); border-radius: 5px; padding: 5px; box-shadow: rgba(0, 0, 0, 0.2) 0px 4px 8px 0px, rgba(0, 0, 0, 0.19) 0px 6px 20px 0px;"><div data-iridize-role="title" class="popover-title"><button aria-label="Close" data-iridize-role="closeBt">✕</button></div><div class="popover-content"><div data-iridize-id="content"><p>NEXT CONTENT</p></div></div><div class="stFooter" data-iridize-id="footer"><div><span class="steps-count">Step <span data-iridize-role="stepCount">2</span>/<span data-iridize-role="stepsCount">2</span></span><button tabindex="999" class="prev-btn default-later-btn" data-iridize-role="laterBt">Remind me later</button><span class="powered-by">Powered by </span></div><div data-iridize-role="nextBtPane"><button tabindex="999" class="prev-btn default-prev-btn" data-iridize-role="prevBt">Back</button><a tabindex="999" role="button" aria-label="Next" class="next-btn" data-iridize-role="nextBt" href="javascript:void(0);">Next</a></div></div></div></div>';
    assert.equal(guide.html(), expectedHTML, "Should match rendered guide");
});
